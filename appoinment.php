...
$data=mysqli_query($con,"INSERT INTO `patient`(`id`, `p_date`, `p_time`, `doctor`, `p_department`,`status`) VALUES('$id','$date','$time','$doctor','$department','pending')");
...
<!--Page Title-->
<section class="page-title text-center" style="background-image:url(images/hospital.jpeg);">
    <div class="container">
                        ...
                        <div class="row">
                          <div class="col-md-6 col-sm-12 col-xs-12">
                            <div class="form-group">
                              ...
                              $data=mysqli_query($con,"SELECT DISTINCT department FROM doctor");
                            ...
                            <div class="form-group">
                              ...
                              <script>
                                ...
                                <div class="form-group">
                                  <!-- <label for="">Available time To:</label> -->
                                    <input type="time" name="time" placeholder="Select Time Slot" required="">
                                </div>   
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                             ...
                             <div class="form-group">
                                    ...
                                    <input type="text" name="date" placeholder="Date" required="" value="<?php echo $rowd['date'];  ?>" id="datepicker">
