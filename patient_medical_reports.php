...
// var_dump($id);
// exit();
$data=mysqli_query($con,"SELECT * FROM `medical_report` INNER JOIN register ON medical_report.id=register.id INNER JOIN doctor ON doctor.id=medical_report.id INNER JOIN patient 
on medical_report.p_id=patient.p_id WHERE patient.id='$id'");
...
<?php
     ...
     {
      echo  "<center><h1>YOU HAVE NO MEDICAL REPORTS TO SHOW</h1></center>";
     }
?>
