...
$data=mysqli_query($con,"INSERT INTO `doctor`( `id`, `photo`, `department`, `date`, `time`) VALUES ('$id','$filenew','$department','$date','$time')");
            ...
            <div class="col-md-6 col-sm-12 col-xs-12">
                <div class="contact-area style-two">
                    <div class="section-title">
                        <h3>Register <span>Profile</span></h3>
                    </div>
                    <form method="POST" class="default-form contact-form"  enctype="multipart/form-data">
                        <div class="row">
                            <div class="col-md-6 col-sm-12 col-xs-12">
                                ...
                                <div class="form-group">
                                    <!-- <label for="time" class="form-label">Choose your consultation Time From:</label> -->
                                    <input type="time" name="time" id="time" placeholder="Select Time Slot" required="">
                                </div>
                            ...
                            <div class="col-md-6 col-sm-12 col-xs-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <!-- <div class="form-group">
                                    <label for="time" class="form-label">Choose your consultation Time To:</label>
                                    <input type="time" name="t_time" id="time" placeholder="Select Time Slot" required="">
                                </div> -->
                            </div>
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                ...
                                <input class="form-control bg-dark" type="file" id="image_id" name="f1" required="">

                                    <!-- <input type="file" name="file" placeholder="Upload your Photo" required=""> -->
                                </div>
                                <div class="form-group text-center">
                                    <button type="submit" class="btn-style-one" name="submit">Add Profile</button>
                                </div>                            
                            </div>
                        </div>
                    </form>
