...
// var_dump($id);
// exit();
$data=mysqli_query($con,"SELECT * FROM `patient`inner join register on patient.id=register.id INNER join doctor on doctor.d_id=patient.doctor WHERE doctor.id='$id'&& status='pending'");
?>
<!DOCTYPE html>
<html>
...
<td><?php echo $row['p_date'];?></td>
 ...
 <td><button><a href="approve.php?pid=<?php echo $row['p_id'];?>">Approve</a></button></td>
 </tr>
...
?>
<br><br>
<center><h2><span style="color:red">You Have No Appoinments</span></h2></center>
<?php
}
?>
