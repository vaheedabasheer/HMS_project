...
$data=mysqli_query($con,"SELECT * FROM `review`");
?>
<!DOCTYPE html>
<html>
...
<!--End Page Title-->
<br><br><br><br>
<center><h3><span style="color:black">Reviews</span></h3></center>
<br><br>
...
?>
    ...
    <td><?php echo $row['name'];?></td>
      ...
      <td><img src="review/<?php echo $row['photo'];?>" alt=""></td>
      <td><?php echo $row['message'];?></td>
      <td><a href="admin_review_del.php?id=<?php echo $row['re_id'];?>">Delete</a></td>
      <?php
      }?>
    </tr>
