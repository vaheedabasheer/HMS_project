...
//  exit();
    if($pic!="")
    {
        $filearray=pathinfo($_FILES['photo']['name']);
        ...
        // var_dump($filenew);
        // exit();
        move_uploaded_file($_FILES['photo']['tmp_name'],"review/".$filenew);
 }
mysqli_query($con,"INSERT INTO `review`(`name`, `email`, `photo`, `message`) VALUES ('$name','$email','$filenew','$message')");
...
<div class="container">
  ...
  <form action="#" class="row" method="post" enctype="multipart/form-data">
                        ...
                        <!-- phone -->
                        <div class="col-md-12">
                            <input type="file" name="photo" class="form-control main" placeholder="photo" required>
                        </div>
                        <!-- message -->
                        <div class="col-md-12">
                        ...
                        <br>
                            <button class="btn btn-style-one" type="submit" name="submit">Send feedback</button>
